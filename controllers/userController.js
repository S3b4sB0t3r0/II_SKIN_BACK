...
const ROLES_VALIDOS = ['cliente', 'admin', 'Detal', 'Mayorista'];
...
// Todos los usuarios entran como 'cliente'.
// El admin cambia el rol desde el dashboard.
// ─────────────────────────────────────────────────────────────
exports.register = async (req, res) => {
  ...
  try {
    ...
    const user = new User({
      ...
      role: 'cliente', // siempre cliente al registrarse — admin asigna roles desde el dashboard
      token: null,
    });
