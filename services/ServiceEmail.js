...
const emailFooter = `
  <div style="background:#1D1D1B;padding:24px 40px;text-align:center;border-top:1px solid rgba(255,255,255,0.06);">
    ...
    <p style="font-size:11px;color:rgba(255,255,255,0.3);margin:0;">
      ...
      ¿Necesitas ayuda? 
      <a href="mailto:iiskincolombia@gmail.com" style="color:#24CEA6;text-decoration:none;">
        iiskincolombia@gmail.com
      </a>
    </p>
  </div>
`;
...
const sendPasswordResetEmail = async (to, token, expiresAt) => {
  const resetUrl = `https://ii-skin.onrender.com/cambio?token=${token}`;
    ...
    <div style="font-family:'Segoe UI',Arial,sans-serif;background-color:#f0f0ee;padding:40px 20px;">
      <div style="max-width:600px;margin:0 auto;border-radius:8px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.18);">
        ...
        <div style="background:#FFFFFF;padding:44px 40px;text-align:center;">
          <div style="width:64px;height:64px;border-radius:50%;background:rgba(36,206,166,0.1);border:2px solid rgba(36,206,166,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;font-size:28px;">🔐</div>
          <h2 style="font-family:'Courier New',monospace;font-size:22px;font-weight:900;color:#1D1D1B;letter-spacing:2px;margin:0 0 12px;">RECUPERA TU ACCESO</h2>
          ...
          <p style="color:#626161;font-size:14px;line-height:1.8;margin:0 0 28px;">
            ...
            <strong style="color:#1D1D1B;">II SKIN SAS</strong>. Haz clic en el botón para continuar.
          </p>
          <a href="${resetUrl}" style="display:inline-block;padding:14px 36px;background:linear-gradient(135deg,#24CEA6,#1ab889);color:#1D1D1B;text-decoration:none;border-radius:3px;font-size:12px;font-weight:800;letter-spacing:3px;text-transform:uppercase;font-family:'Courier New',monospace;">
      ...
      <div style="max-width:600px;margin:0 auto;border-radius:8px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.18);">
        ...
        <div style="background:#FFFFFF;padding:44px 40px;">
          <div style="display:inline-block;background:rgba(36,206,166,0.1);border:1px solid rgba(36,206,166,0.3);border-radius:2px;padding:5px 14px;margin-bottom:20px;">
            <span style="font-size:9px;letter-spacing:3px;text-transform:uppercase;font-weight:700;color:#24CEA6;">✉ Nuevo Mensaje de Contacto</span>
          </div>
          <h2 style="font-family:'Courier New',monospace;font-size:20px;font-weight:900;color:#1D1D1B;margin:0 0 8px;">${name}</h2>
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
            ...
            ${company ? `<tr><td style="padding:10px 14px;background:#fafaf8;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#626161;font-weight:700;border-bottom:1px solid #ebebea;">Empresa</td><td style="padding:10px 14px;background:#fafaf8;font-size:13px;color:#1D1D1B;border-bottom:1px solid #ebebea;">${company}</td></tr>` : ''}
            ${phone ? `<tr><td style="padding:10px 14px;background:#f5f5f3;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#626161;font-weight:700;border-bottom:1px solid #ebebea;">Teléfono</td><td style="padding:10px 14px;background:#f5f5f3;font-size:13px;color:#1D1D1B;border-bottom:1px solid #ebebea;">${phone}</td></tr>` : ''}
            ${projectType ? `<tr><td style="padding:10px 14px;background:#fafaf8;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#626161;font-weight:700;border-bottom:1px solid #ebebea;">Tipo</td><td style="padding:10px 14px;background:#fafaf8;font-size:13px;color:#1D1D1B;border-bottom:1px solid #ebebea;">${projectType}</td></tr>` : ''}
          </table>
          ...
          <div style="margin-top:24px;text-align:center;">
            <a href="mailto:${email}" style="display:inline-block;padding:12px 28px;background:#E73538;color:#FFFFFF;text-decoration:none;border-radius:3px;font-size:11px;font-weight:800;letter-spacing:3px;text-transform:uppercase;font-family:'Courier New',monospace;">Responder desde Gmail →</a>
          </div>
        </div>
        ${emailFooter}
      </div>
  ...
  const html = `
    <div style="font-family:'Segoe UI',Arial,sans-serif;background-color:#f0f0ee;padding:40px 20px;">
      <div style="max-width:600px;margin:0 auto;border-radius:8px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.18);">
        ...
        <div style="background:#FFFFFF;padding:44px 40px;">
          <div style="display:inline-block;background:rgba(36,206,166,0.1);border:1px solid rgba(36,206,166,0.3);border-radius:2px;padding:5px 14px;margin-bottom:20px;">
            <span style="font-size:9px;letter-spacing:3px;text-transform:uppercase;font-weight:700;color:#24CEA6;">💬 Respuesta a tu mensaje</span>
          </div>
          <h2 style="font-family:'Courier New',monospace;font-size:22px;font-weight:900;color:#1D1D1B;letter-spacing:2px;margin:0 0 8px;">HOLA, ${name.toUpperCase()}</h2>
          <div style="width:40px;height:3px;background:linear-gradient(90deg,#E73538,#24CEA6);margin:0 0 20px;border-radius:2px;"></div>
          <p style="color:#626161;font-size:14px;line-height:1.8;margin:0 0 28px;">
            Gracias por contactarte con <strong style="color:#1D1D1B;">II SKIN SAS</strong>. Hemos revisado tu mensaje y te compartimos nuestra respuesta:
          </p>
          <div style="background:#1D1D1B;border-radius:4px;padding:24px;position:relative;overflow:hidden;margin-bottom:28px;">
            <div style="position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#24CEA6,#E73538);"></div>
            <p style="font-size:9px;letter-spacing:3px;text-transform:uppercase;color:#24CEA6;font-weight:700;margin:0 0 10px;">Respuesta del equipo II SKIN</p>
          ...
          <div style="text-align:center;margin-bottom:28px;">
            <p style="color:#626161;font-size:13px;margin:0 0 16px;">¿Querés ver nuestra colección mientras tanto?</p>
            <a href="https://ii-skin.onrender.com" style="display:inline-block;padding:13px 32px;background:linear-gradient(135deg,#24CEA6,#1ab889);color:#1D1D1B;text-decoration:none;border-radius:3px;font-size:11px;font-weight:800;letter-spacing:3px;text-transform:uppercase;font-family:'Courier New',monospace;">Ver Tienda II SKIN →</a>
          </div>
          <div style="padding:14px 18px;background:#f5f5f3;border-radius:4px;border-left:3px solid #E73538;">
            <p style="font-size:12px;color:#626161;margin:0;line-height:1.7;">
              ...
              <a href="mailto:iiskincolombia@gmail.com" style="color:#24CEA6;text-decoration:none;">iiskincolombia@gmail.com</a>
            </p>
          </div>
        </div>
        ${emailFooter}
    ...
    <div style="font-family:'Segoe UI',Arial,sans-serif;background-color:#f0f0ee;padding:40px 20px;">
      <div style="max-width:600px;margin:0 auto;border-radius:8px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.18);">
        ...
        <div style="background:#1D1D1B;padding:40px;text-align:center;position:relative;overflow:hidden;">
          <p style="font-size:9px;letter-spacing:4px;text-transform:uppercase;color:#24CEA6;margin:0 0 10px;font-weight:700;">Bienvenido/a a la familia</p>
          <h2 style="font-family:'Courier New',monospace;font-size:28px;font-weight:900;color:#FFFFFF;margin:0;letter-spacing:2px;">${name.toUpperCase()}</h2>
        ...
        <div style="background:#FFFFFF;padding:44px 40px;text-align:center;">
          <p style="color:#626161;font-size:15px;line-height:1.8;margin:0 0 28px;">
            Tu cuenta en <strong style="color:#1D1D1B;">II SKIN SAS</strong> fue creada exitosamente. Ahora eres parte de la comunidad que vive al máximo.
          </p>
          ...
          <a href="https://ii-skin.onrender.com" style="display:inline-block;padding:14px 36px;background:linear-gradient(135deg,#24CEA6,#1ab889);color:#1D1D1B;text-decoration:none;border-radius:3px;font-size:12px;font-weight:800;letter-spacing:3px;text-transform:uppercase;font-family:'Courier New',monospace;">Explorar Tienda →</a>
          <div style="margin-top:28px;padding:14px 18px;background:rgba(231,53,56,0.05);border-radius:4px;border:1px solid rgba(231,53,56,0.15);">
            <p style="font-size:12px;color:#626161;margin:0;line-height:1.7;">
              <strong style="color:#E73538;">Aviso de seguridad:</strong> Si no fuiste tú quien creó esta cuenta, contáctanos a
              <a href="mailto:iiskincolombia@gmail.com" style="color:#24CEA6;text-decoration:none;">iiskincolombia@gmail.com</a>
            </p>
          </div>
        </div>
